...
extern int rtl2832_pid_filter_ctrl(struct dvb_frontend *fe, int onoff, int slave);
...
static inline int rtl2832_pid_filter(struct dvb_frontend *fe, int index,
						u16 pid, int onoff, int slave)
{
